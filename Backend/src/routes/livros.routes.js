...
router.post("/", upload.single('capa'), livrosController.criarLivro.bind(livrosController));
router.put("/:id", validarParamId, upload.single('capa'), livrosController.atualizarLivro.bind(livrosController));
